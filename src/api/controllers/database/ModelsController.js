...
const { Postal_Codes_X_Streets } = require("../../database/models/Postal_Codes_X_Streets");
const { Postal_Codes } = require("../../database/models/Postal_Codes");
const { Contact_Types } = require("../../database/models/Contact_Types");
const { Postal_Codes_X_Paths } = require("../../database/models/Postal_Codes_X_Paths");
...
const { People_X_Contacts } = require("../../database/models/People_X_Contacts");
...
const { Conteiner_Type_Dimensions } = require("../../database/models/Conteiner_Type_Dimensions");
const { Conteiner_Types } = require("../../database/models/Conteiner_Types");
const { Packagings } = require("../../database/models/Packagings");
const { Gtin_Types } = require("../../database/models/Gtin_Types");
const { Conteiner_Type_Capacities } = require("../../database/models/Conteiner_Type_Capacities");
...
const { Item_X_Meas_X_Pack_X_Identif } = require("../../database/models/Item_X_Meas_X_Pack_X_Identif");
...
const { Movements_X_Groups } = require("../../database/models/Movements_X_Groups");
const { Movs_X_Items_Stocks } = require("../../database/models/Movs_X_Items_Stocks");
const { Movements_X_Entities } = require("../../database/models/Movements_X_Entities");
...
class ModelsController{
    ...
    static initModels(){    
        ...
        Streets.getModel();
        Postal_Codes_X_Streets.getModel();
        Postal_Codes.getModel();
        Contact_Types.getModel();
        Postal_Codes_X_Paths.getModel();
        Addresses.getModel();
        Contacts.getModel();
        Companies.getModel();
        People_X_Addresses.getModel();
        People_X_Contacts.getModel();
        ...
        Conteiner_Type_Dimensions.getModel();
        Conteiner_Types.getModel();
        Packagings.getModel();
        Gtin_Types.getModel();
        Conteiner_Type_Capacities.getModel();
        Ncms.getModel();
        ...
        Items_X_Lots_X_Conteiners.getModel();
        Item_Stocks.getModel();
        Stock_Entity_Relationship_Types.getModel();
        Item_X_Meas_X_Pack_X_Identif.getModel();
        ...
        Movements_X_Groups.getModel();
        Movs_X_Items_Stocks.getModel();
        Movements_X_Entities.getModel();
        ...
        Logistic_Orders_X_Movs.getModel();
        Logistic_Orders_X_Items_Mov_Amt.getModel();
        Logistic_Orders_X_Movs_X_Receipt_Values.getModel();
        Logistic_Orders_X_Dest_Values.getModel();        
        Logistic_Logs.getModel();        

        Task_Status.getModel();
        Tasks.getModel();
        Tasks_X_Status_X_Users.getModel();
        Tasks_X_Status_X_Users_Logs.getModel();
        Apis.getModel();
    ...
    static initAssociations(){
        ...
        Postal_Codes_X_Streets.initAssociations();
        Postal_Codes.initAssociations();
        Contact_Types.initAssociations();
        Postal_Codes_X_Paths.initAssociations();
        Addresses.initAssociations();
        Contacts.initAssociations();
        Companies.initAssociations();
        People_X_Addresses.initAssociations();
        People_X_Contacts.initAssociations();
        ...
        Conteiner_Type_Dimensions.initAssociations();
        Conteiner_Types.initAssociations();
        Packagings.initAssociations();
        Gtin_Types.initAssociations();
        Conteiner_Type_Capacities.initAssociations();
        ...
        Items_X_Lots_X_Conteiners.initAssociations();
        Item_Stocks.initAssociations();
        Stock_Entity_Relationship_Types.initAssociations();
        Item_X_Meas_X_Pack_X_Identif.initAssociations();
        ...
        Movements_X_Groups.initAssociations();
        Movs_X_Items_Stocks.initAssociations();
        Movements_X_Entities.initAssociations();
        ...
        Logistic_Orders_X_Movs_X_Receipt_Values.initAssociations();
        Logistic_Orders_X_Dest_Values.initAssociations();
        Logistic_Logs.initAssociations();        
        Task_Status.initAssociations();
        Tasks.initAssociations();
        Tasks_X_Status_X_Users.initAssociations();
        Tasks_X_Status_X_Users_Logs.initAssociations();
