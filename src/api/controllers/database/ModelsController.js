...
const { AddressesTypes } = require("../../database/models/AddressesTypes");
...
const { WarehousesAddressesTypes } = require("../../database/models/WarehousesAddressesTypes");
...
class ModelsController{
    ...
    static initModels(){    
        ...
        WarehousesAddressesTypes.getModel();
        Warehouses.getModel();
    ...
    static initAssociations(){
        ...
        ActionsStatus.initAssociations();
        ...
        AddressesTypes.initAssociations();
        ...
        WarehousesAddressesTypes.initAssociations();
