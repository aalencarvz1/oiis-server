 ...
 * @created 2023-09-05
 */
class ProductsIntegrationController extends RegistersController {
    ...
    static async get(req,res,next) {
        try {
            ...
            switch((origin.name || origin).trim().toLowerCase()) {
                case "winthor":                                                
                    res.data = await PcProdut.getModel().findAll(queryParams);
...
module.exports = {ProductsIntegrationController}