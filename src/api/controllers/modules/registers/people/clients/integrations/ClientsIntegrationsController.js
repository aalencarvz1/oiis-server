 ...
 * @created 2023-09-08
 */
class ClientsIntegrationsController extends RegistersController{
    ...
    static async integrateEpClientToClient(params) {    
        ...
        try {    
            ...
            let resultPeople = await PeopleIntegrationsController.integrateEpPeople(peopleParams);
...
module.exports = {ClientsIntegrationsController}