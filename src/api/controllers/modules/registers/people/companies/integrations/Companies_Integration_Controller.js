 ...
 * @created 2023-09-08
 */
class Companies_Integration_Controller extends RegistersController{
        ...
        try {
            ...
            if (identifiers.length > 0) {
                ...
                for(let key in identifiers) {
                    res.data.push(await Companies_Integration_Controller.integrateWinthorPcFilialToCompany(identifiers[key]));
                }
...
module.exports = {Companies_Integration_Controller}