 ...
 * @created 2023-09-08
 */
class CountriesIntegrationsController extends RegistersController {
        ...
        try {
            ...
            if (identifiers.length > 0) {
                ...
                for(let key in identifiers) {
                    res.data.push(await CountriesIntegrationsController.integrateWinthorPcPaisToCountry(identifiers[key]));
                }
...
module.exports = {CountriesIntegrationsController}