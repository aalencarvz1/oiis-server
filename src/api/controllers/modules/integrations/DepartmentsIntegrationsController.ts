...
import WinthorDepartmentsIntegrationsController from "./winthor/WinthorDepartmentsIntegrationsController.js";
    ...
    static async get(req: Request, res: Response, next: NextFunction) : Promise<void> {
        try {
            ...
            switch((origin.name || origin.label || origin).trim().toLowerCase()) {                        
                case "winthor":
                    res.data = await WinthorDepartmentsIntegrationsController.get(req.body);
