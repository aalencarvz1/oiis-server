...
export default {
  async up(queryInterface: QueryInterface, Sequelize: any) {    
    ...
    await queryInterface.bulkInsert(Relationships.tableName,[{      
      ...
      table_1_id: Projects_Items_Types.id,
      record_1_column: 'id',
      record_1_id: Projects_Items_Types.AGILE_METHODOLOGIES,
      table_2_id: Projects_Items_Types.id,
      record_2_column: 'parent_id',
      record_2_id: Projects_Items_Types.PROJECT,
    },{      
      ...
      table_1_id: Projects_Items_Types.id,
      record_1_column: 'id',
      record_1_id: Projects_Items_Types.BACKLOGS,
      table_2_id: Projects_Items_Types.id,
      record_2_column: 'parent_id',
      record_2_id: Projects_Items_Types.PROJECT,
    },{      
      ...
      table_1_id: Projects_Items_Types.id,
      record_1_column: 'id',
      record_1_id: Projects_Items_Types.SPRINTS,
      table_2_id: Projects_Items_Types.id,
      record_2_column: 'parent_id',
      record_2_id: Projects_Items_Types.PROJECT,
    },{      
      ...
      table_2_id: Projects_Items_Types.id,
      record_2_column: 'parent_id',
      record_2_id: Projects_Items_Types.AGILE_METHODOLOGY,
    },{      
      status_reg_id: Record_Status.ACTIVE,
      creator_user_id : Users.SYSTEM,
      created_at: new Date(),
