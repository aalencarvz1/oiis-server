...
import ComparatorsController from "../../../../../dist/api/controllers/modules/registers/ComparatorsController";
import Comparators from "../../../../../dist/api/database/models/Comparators";
import HelperTestController from "../../HelperTestController";

const stringTest = 'TEST_001005';

describe(ComparatorsController.name, () => {
    ...
    test('table class model name', () => {
        let tableClassModel = ComparatorsController.getTableClassModel();
    ...
    test('put without data', async () => {
        let result = await ComparatorsController._put({}) 
    ...
    test('put', async () => {
        ...
        result = await ComparatorsController._get({
            where:{
                name: stringTest,
            }
        });
    ...
    test('get', async () => {
        let result = await ComparatorsController._get({
            where: { 
                name : stringTest 
            }
        });
    ...
    test('patch', async () => {
        ...
        result = await ComparatorsController._patch({
            where: {
                id: id
            },
            values:{
    ...
    test('delete', async () => {
        ...
        result = await ComparatorsController._delete({
            where:{
                id:id,
            }
        });
