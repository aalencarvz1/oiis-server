...
import Form_TypesController from "../../../../../dist/api/controllers/modules/registers/Form_TypesController";
import HelperTestController from "../../HelperTestController";
import Form_Types from "../../../../../dist/api/database/models/Form_Types";

const stringTest = 'TEST_001031';

describe(Form_TypesController.name, () => {
    ...
    test('table class model name', () => {
        let tableClassModel = Form_TypesController.getTableClassModel();
    ...
    test('put without data', async () => {
        let result = await Form_TypesController._put({}) 
    ...
    test('put', async () => {
        ...
        result = await Form_TypesController._get({
            where:{
                name: stringTest,
            }
        });
    ...
    test('get', async () => {
        let result = await Form_TypesController._get({
            where: { 
                name : stringTest 
            }
        });
    ...
    test('patch', async () => {
        ...
        result = await Form_TypesController._patch({
            where: {
                id: id
            },
            values:{
    ...
    test('delete', async () => {
        ...
        result = await Form_TypesController._delete({
            where:{
                id:id,
            }
        });
