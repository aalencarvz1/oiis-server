...
import Contract_TypesController from "../../../../../dist/api/controllers/modules/registers/Contract_TypesController";
import Contract_Types from "../../../../../dist/api/database/models/Contract_Types";
import HelperTestController from "../../HelperTestController";

const stringTest = 'TEST_001020';

describe(Contract_TypesController.name, () => {
    ...
    test('table class model name', () => {
        let tableClassModel = Contract_TypesController.getTableClassModel();
    ...
    test('put without data', async () => {
        let result = await Contract_TypesController._put({}) 
    ...
    test('put', async () => {
        ...
        result = await Contract_TypesController._get({
            where:{
                name: stringTest,
            }
        });
    ...
    test('get', async () => {
        let result = await Contract_TypesController._get({
            where: { 
                name : stringTest 
            }
        });
    ...
    test('patch', async () => {
        ...
        result = await Contract_TypesController._patch({
            where: {
                id: id
            },
            values:{
    ...
    test('delete', async () => {
        ...
        result = await Contract_TypesController._delete({
            where:{
                id:id,
            }
        });
