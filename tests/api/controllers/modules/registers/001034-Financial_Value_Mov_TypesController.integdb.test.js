...
import Financial_Value_Mov_TypesController from "../../../../../dist/api/controllers/modules/registers/Financial_Value_Mov_TypesController";
import HelperTestController from "../../HelperTestController";
import Financial_Value_Mov_Types from "../../../../../dist/api/database/models/Financial_Value_Mov_Types";

const stringTest = 'TEST_001034';

describe(Financial_Value_Mov_TypesController.name, () => {
    ...
    test('table class model name', () => {
        let tableClassModel = Financial_Value_Mov_TypesController.getTableClassModel();
    ...
    test('put without data', async () => {
        let result = await Financial_Value_Mov_TypesController._put({}) 
    ...
    test('put', async () => {
        ...
        result = await Financial_Value_Mov_TypesController._get({
            where:{
                name: stringTest,
            }
        });
    ...
    test('get', async () => {
        let result = await Financial_Value_Mov_TypesController._get({
            where: { 
                name : stringTest 
            }
        });
    ...
    test('patch', async () => {
        ...
        result = await Financial_Value_Mov_TypesController._patch({
            where: {
                id: id
            },
            values:{
    ...
    test('delete', async () => {
        ...
        result = await Financial_Value_Mov_TypesController._delete({
            where:{
                id:id,
            }
        });
