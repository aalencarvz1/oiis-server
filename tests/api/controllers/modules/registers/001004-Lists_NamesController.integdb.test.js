...
import Lists_NamesController from "../../../../../dist/api/controllers/modules/registers/Lists_NamesController";
import Lists_Names from "../../../../../dist/api/database/models/Lists_Names";
import HelperTestController from "../../HelperTestController";

const stringTest = 'TEST_001004';

describe(Lists_NamesController.name, () => {
    ...
    test('table class model name', () => {
        let tableClassModel = Lists_NamesController.getTableClassModel();
    ...
    test('put without data', async () => {
        let result = await Lists_NamesController._put({}) 
    ...
    test('put', async () => {
        ...
        result = await Lists_NamesController._get({
            where:{
                name: stringTest,
            }
        });
    ...
    test('get', async () => {
        let result = await Lists_NamesController._get({
            where: { 
                name : stringTest 
            }
        });
    ...
    test('patch', async () => {
        ...
        result = await Lists_NamesController._patch({
            where: {
                id: id
            },
            values:{
    ...
    test('delete', async () => {
        ...
        result = await Lists_NamesController._delete({
            where:{
                id:id,
            }
        });
